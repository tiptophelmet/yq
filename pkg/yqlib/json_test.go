...
var jsonScenarios = []formatScenario{
	...
	},
	{
		...
		skipDoc:       true,
		input:         `{"a": 1 b": 2}`,
		expectedError: `bad file 'sample.yml': invalid character 'b' after object key:value pair`,
		scenarioType:  "decode-error",
	},
	{
		description:   "bad json: missing comma between object members",
		skipDoc:       true,
		input:         "{\n  \"hello\": \"value\"\n  \"foo\": \"bar\"\n}",
	...
	{
		description:   "bad json: missing comma between array elements",
		skipDoc:       true,
		input:         `["a" "b"]`,
		expectedError: `bad file 'sample.yml': invalid character '"' after array element`,
		scenarioType:  "decode-error",
	},
	{
		description:   "bad json: trailing garbage after document",
		skipDoc:       true,
		input:         `{"a":1} garbage`,
		expectedError: `bad file 'sample.yml': invalid character 'g' looking for beginning of value`,
		scenarioType:  "decode-error",
	},
	{
		description:   "bad json: unterminated object",
		skipDoc:       true,
		input:         `{"a":1`,
		expectedError: `bad file 'sample.yml': unexpected EOF`,
		scenarioType:  "decode-error",
	},
	{
		description:  "deeply nested values",
		skipDoc:      true,
		input:        `{"a":{"b":{"c":{"d":[1,2,{"e":"deep"}]}}}}`,
		expected:     "a:\n  b:\n    c:\n      d:\n        - 1\n        - 2\n        - e: deep\n",
		scenarioType: "decode-ndjson",
	},
	{
		description:  "large and precise numbers",
		skipDoc:      true,
		input:        "[123456789012345678, 1.7976931348623157e+308, 0.1]",
		expected:     "- 123456789012345680\n- 1.7976931348623157e+308\n- 0.1\n",
		scenarioType: "decode-ndjson",
	},
	{
		description:  "strings with escapes",
		skipDoc:      true,
		input:        `["line1\nline2", "tab\there", "quote\"inside", "unicode\u00e9"]`,
		expected:     "- |-\n  line1\n  line2\n- \"tab\\there\"\n- quote\"inside\n- unicodeé\n",
		scenarioType: "decode-ndjson",
	},
	{
